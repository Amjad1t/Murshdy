...
class Chat{
    ...
    private $chatUsersTable = 'student';
    private $recieverTable = 'advisor';
    ...
    $sqlQuery = "
        ...
        WHERE A_ID = (
            SELECT A_ID FROM ".$this->chatUsersTable." 
	...
	public function getUserDetailz($userid){
		$sqlQueryz = "
			SELECT * FROM ".$this->recieverTable." 
			WHERE S_ID = '$currentSession'";
		return  $this->getData($sqlQueryz);
	}
