...
$sql_files = "SELECT student.Name AS student_name,student.S_ID, sick_leave.Date,sick_leave.Si_ID,sick_leave.file_path, sick_leave.Status
              FROM sick_leave
    ...
    <tbody>
        ...
        if ($result_files->num_rows > 0) {
            while ($row_file = $result_files->fetch_assoc()) {
                ...
                echo "<td><a href='" . $row_file["file_path"] . "' target='_blank'>Download File</a></td>"; 
                ...
                echo "<td><a href='approve.php?id={$row_file['S_ID']}&si_id={$row_file['Si_ID']}'>Modify Status</a></td>";
                echo "</tr>";
            }
        } else {
            echo "<tr><td colspan='5'>No uploaded files found.</td></tr>";
        }
        ?>
    </tbody>
</table>
